    ...
    <div class="info-nav nav-icon">
      <div class="row no-gutters">
        <div class="col-lg-3 col-sm-3 col-xs-3 col-md-3">
          <a href="https://www.Goblin88.site/info.php" class="">
            <div>
            ...
            <div>TERMS &amp; CONDITIONS </div>
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3 col-md-3">
          <a href="https://www.Goblin88.site/info.php" class="active">
...
<nav class="navbar navbar-expand-lg navbar-light navbar-default  ">
  ...
  <div class="navbar-header d-lg-none clearfix">
    ...
    <div class="menu-select d-lg-none" id="menu-select--info">General</div>
  </div>

  <div class="collapse navbar-collapse" [ngclass]="{ 'show in': navbarOpen }">
    <ul class="navbar-nav mt-lg-0" style="list-style-type:none;">
      <li class="nav-item">
        <a class="nav-link active" href="https://www.Goblin88.site/info.php" data-pg="general">General</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="https://www.Goblin88.site/info.php" data-pg="deposit">Deposits</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="https://www.Goblin88.site/info.php" data-pg="faq_withdrawal">Withdrawal</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="https://www.Goblin88.site/info.php" data-pg="games">Gaming</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="https://www.Goblin88.site/info.php" data-pg="technical">Technical</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="https://www.Goblin88.site/info.php" data-pg="banking">Banking</a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="panel-group" id="info_accordion">
    <!-- First Panel -->
    <!-- '1. Tentang Mercusuar77'=> <br>'1. Tentang Mercusuar77',<br>'2. Kenapa Mercusuar77?'=> <br>'2. Kenapa Mercusuar77?',<br>'3. Afiliasi?'=> <br>'3. Afiliasi?',<br>'4. Cara Bergabung?'=> <br>'4. Cara Bergabung?',<br>'5. Mata uang apa yang digunakan di Mercusuar77?'=> <br>'5. Mata uang apa yang digunakan di Mercusuar77?',<br>'6. Persyaratan usia ?'=> <br>'6. Persyaratan usia ?',<br>'7. Bagaimana cara melakukan deposit di akun Goblin$88 ?'=> <br>'7. Bagaimana cara melakukan deposit di akun Goblin$88 ?',<br>'8. Bagaimana saya bisa yakin bahwa permainan itu adil ?'=> <br>'8. Bagaimana saya bisa yakin bahwa permainan itu adil ?',<br>'9. Apakah informasi pribadi saya aman ?'=> <br>'9. Apakah informasi pribadi saya aman ?',<br> -->
        ...
        <div class="info panel-heading" data-toggle="collapse" data-parent="#info_accordion" data-target="#collapse1">
             <h5 class="panel-title info">
                 1. Tentang Goblin$88            </h5>
        </div>
        <div id="collapse1" class="panel-collapse collapse">
            <div class="info panel-body">
                 <p>
               Goblin$88 adalah merek hiburan online yang melayani pasar Asia Pasifik, terutama Indonesia, Malaysia dan Cina. Produk yang ditawarkan terutama pada berbagai permainan online seperti taruhan sepakbola online, kasino online, slot, keno dan lotere, biner, poker, dan permainan lainnya.
               <br>
               <br>
                Goblin$88 Salah satu kasino terkemuka di Asia.
               <br>
               <br>
               Visi Mercusuar77adalah untuk menyediakan hiburan berkualitas tinggi dan game bernilai tinggi bagi para pelanggannya. Mercusuar77berkomitmen untuk menyediakan produk-produk permainan yang memimpin industri yang selalu didukung oleh promosi apa pun. Kelompok staf profesional disediakan untuk memastikan bahwa dengan bermain di Mercusuar77, Anda akan selalu mendapatkan pengalaman terbaik di sini.
            </p>            </div>
        </div>
    </div>
     <div class="panel info panel-default">
        <div class="info panel-heading" data-toggle="collapse" data-parent="#info_accordion" data-target="#collapse2">
             <h5 class="panel-title info">
                 2. Kenapa Mercusuar77?             </h5>
        </div>
        <div id="collapse2" class="panel-collapse collapse">
            <div class="info panel-body">
                  <p>Seiring dengan promosi yang terus-menerus Mercusuar77menawarkan peluang terbaik dalam setidaknya 1.000 jenis game sportsbook online terkemuka di pasar seperti liga sepak bola mulai dari Inggris, Spanyol, Eropa, Jerman serta olahraga lain seperti NBA, NFL, NCAA, Tenis, F1, dan taruhan olahraga lainnya. Selain taruhan olahraga, Mercusuar77juga menyediakan berbagai permainan langsung, didukung oleh dealer online kasino, melalui Lobi Live Kasino, Anda akan dibawa ke Live Baccarat, Live Sic Bo, Live Dragon Tiger, Live Roulette, Live Kasino, Slot dan game menarik lainnya.
             </p>            </div>
        </div>
    </div>
     <div class="panel info panel-default">
        ...
        <div id="collapse3" class="panel-collapse collapse">
            <div class="info panel-body">
                 <p>
             Jadilah mitra kami dan dapatkan komisi menarik bernilai tinggi setiap bulan dengan mengundang teman-teman Anda untuk bermain di Mercusuar77. Click <a href="#">here</a> tentang cara menjadi afiliasi kami</p>            </div>
        </div>
    </div>
     <div class="panel info panel-default">
            ...
            <div class="info panel-body">
                 ...
                 <ol type="a">
                   <li>
                     ...
                     <ol>
                       <li>Login ke situs web Mercusuar77, pilih menu "GABUNG"</li>
                       <li>Isi formulir pendaftaran yang disediakan. Semua informasi dibutuhkan oleh data yang valid / benar, lalu pilih "SUBMIT"</li>
                       <li>Email konfirmasi akan dikirim ke email yang terdaftar dan dimaksudkan untuk mengkonfirmasi nama pengguna dan kata sandi yang terdaftar.</li>
                       <li>Kembali ke situs Mercusuar77, pilih "LOGIN"</li>
                       <li>Anda dapat melanjutkan ke langkah selanjutnya yang akan dimulai dari Deposit.</li>
                     </ol>
                   </li>
                   <br>
                   <br>
                   <li>
                     ...
                     <ol>
                       <li>Masuk ke situs web Mercusuar77, pilih menu "AFILIASI"</li>
                       <li>Isi formulir pendaftaran yang disediakan. Semua informasi yang dibutuhkan oleh data yang benar / benar, kemudian pilih "KIRIM"</li>
                       <li>Email konfirmasi akan dikirim ke email terdaftar dan dimaksudkan untuk mengkonfirmasi dan mengaktifkan nama pengguna dan kata sandi yang terdaftar.</li>
                       <li>Formulir yang dikirimkan akan melalui proses seleksi oleh Mercusuar77.</li>
                       <li>Pemohon yang berhasil akan dihubungi oleh Mercusuar77melalui email, terkait dengan yang telah ditentukan sebelumnya syarat dan ketentuan Afiliasi Mercusuar77.</li>
                     </ol>
                   </li>
                 </ol>            </div>
        </div>
     ...
     <div class="panel info panel-default">
        <div class="info panel-heading" data-toggle="collapse" data-parent="#info_accordion" data-target="#collapse5">
             <h5 class="panel-title info">
                 5. Mata uang apa yang digunakan di Mercusuar77?             </h5>
        </div>
        <div id="collapse5" class="panel-collapse collapse">
            <div class="info panel-body">
                 <p>Goblin$88 untuk saat ini hanya menerima   mata uang Rupiah.</p>            </div>
        </div>
    </div>
     <div class="panel info panel-default">
     ...
     <div class="panel info panel-default">
        <div class="info panel-heading" data-toggle="collapse" data-parent="#info_accordion" data-target="#collapse7">
             <h5 class="panel-title info">
                 7. Bagaimana cara melakukan deposit di akun Mercusuar77?             </h5>
        </div>
        <div id="collapse7" class="panel-collapse collapse">
            <div class="info panel-body">
                  <p>Dana dapat disetorkan ke Akun Mercusuar77Anda melalui sejumlah metode. Lebih detailnya bisa dilihat dari INFO <a href="https://www.Goblin88.site/info/faq-banking">here</a>.</p>
                         </div>
        </div>
    </div>
     <div class="panel info panel-default">
     ...
     <div class="panel info panel-default">
        ...
        <div id="collapse9" class="panel-collapse collapse">
            <div class="info panel-body">
                 <p>Kami akan memastikan bahwa detail Anda aman setiap saat. Kami menggunakan langkah-langkah keamanan kualitas terbaik Secure Socket (enkripsi 128 128 enkripsi Standar) (Standar enkripsi 128 128 SSL) dan disimpan di lingkungan operasi yang aman yang memungkinkan pelanggan melakukan pembayaran online tidak pernah lebih aman. Mercusuar77tidak akan mengungkapkan informasi pribadi Anda kepada pihak ketiga mana pun.</p>            </div>
        </div>
    </div>
...
<script>
        ...
        window.onLogOut = async function(){
            ...
            window.location.href="https://www.Goblin88.site/logout";
        ...
        window.json_post(
         ...
         window.sweetAlert= function ( msg , type , title  ,showCancelBtn   ) {
            //check CF error
            var dateNow = "2026-02-25 04:34:05";
...
<iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" tabindex="-1" vspace="0" width="100%" aria-hidden="true" id="I0_1771965246259" name="I0_1771965246259" src="https://api-kixplay-live1.firebaseapp.com/__/auth/iframe?apiKey=AIzaSyA6hCmsU1Tx-_rB9st6TiXLT_M3D-qQ9aw&amp;appName=%5BDEFAULT%5D&amp;v=11.3.0&amp;eid=p&amp;usegapi=1&amp;jsh=m%3B%2F_%2Fscs%2Fabc-static%2F_%2Fjs%2Fk%3Dgapi.lb.id.8ECc3i-niIA.O%2Fd%3D1%2Frs%3DAHpOoo8g466w4vfctJFQ7iHLN0dzTSqREg%2Fm%3D__features__#id=I0_1771965246259&amp;_gfid=I0_1771965246259&amp;parent=https%3A%2F%2Ffriteusecuisine.com&amp;pfname=&amp;rpctoken=12645444" style="position: absolute; top: -100px; width: 1px; height: 1px;"></iframe><veepn-lock-screen><style>@font-face{font-family:FigtreeVF;src:url(chrome-extension://majdfhpaihoncoakbjgbdhglocklcgno/fonts/FigtreeVF.woff2) format("woff2 supports variations"),url(chrome-extension://majdfhpaihoncoakbjgbdhglocklcgno/fonts/FigtreeVF.woff2) format("woff2-variations");font-weight:100 1000;font-display:swap}</style></veepn-lock-screen></body></html>