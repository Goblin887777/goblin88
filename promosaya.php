  ...
  <div class="container container-box noSidePadding">
    ...
    <div class="head-content">
      <div class="row no-gutters">
          ...
          <!---->
            <a role="tab" href="https://www.Goblin88.site/promosaya.php" data-tabname="my-promo" data-active="promomy-promo" class="mdc-tab mdc-tab--active active" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-2">
            ...
            <span class="mdc-tab-indicator mdc-tab-indicator--active active">
          ...
          <!---->
                      ...
                      <a role="tab" href="https://www.Goblin88.site/promosaya.php" data-tabname="my-bonus" data-active="promomy-bonus" class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-2">
                        <span class="mdc-tab__content">
          ...
          <!---->
          <a role="tab" href="https://www.Goblin88.site/promosaya.php" data-tabname="my-withdraw-to" data-active="promomy-withdraw-to" class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-2">
            <span class="mdc-tab__content">
              <span class="mdc-tab__text-label">Turnover Deposit Saya</span>
            </span>
            <span class="mdc-tab-indicator">
      ...
      <div class="outlet tab-content" style="margin: 10px;">
        <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab"><div class="row my-promo">
    <div class="col-lg-5 col-xs-12"> 
      <div class="row">
        <div class="col-md-4 noSidePadding"> <p class="lbl" i18n="">Promosi:</p> </div>
      ...
      <div class="row">
        <div class=" col-xs-6 col-md-4 noSidePadding"> <p class="lbl" i18n="">Jenis Promosi:</p> </div>
        <div class="col-xs-6 col-md-8 noSidePadding">
           <p>-</p> 
        </div>
      </div>
      <div class="row">
        <div class="col-xs-6 col-md-4 noSidePadding">  <p class="lbl" i18n="">Total Bonus + Deposit:</p> </div>
        <div class="col-xs-6 col-md-8 noSidePadding"> 
          <p>-</p>
        </div>
      </div>
    ...
    <div class="col-lg-7 col-xs-12 ">
                  <div class="row">
        <div class=" col-xs-7 col-md-4 noSidePadding"> <p class="lbl" i18n="">Tanggal Berakhir Promosi:</p> </div>
      ...
      <div class="row">
        <div class="col-xs-2 col-md-4 noSidePadding"> <p class="lbl" i18n=""> Status:</p> </div>
...
<script>
        ...
        window.json_post(
         ...
         window.sweetAlert= function ( msg , type , title  ,showCancelBtn   ) {
            //check CF error
            var dateNow = "2026-02-23 08:29:19";
