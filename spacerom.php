...
// --- LOGIKA LOCK GAME (SWEETALERT REDIRECT) ---
// Jika status_game di Firebase bernilai '0', user ditendang balik ke Home
if (isset($row['status_game']) && $row['status_game'] == '0') {
    echo "<html><head>
    <script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
    <style>body { background-color: #0b0b0b; color: white; display: flex; justify-content: center; align-items: center; height: 100vh; margin: 0; }</style>
    </head><body>
    <script>
        Swal.fire({
            title: 'AKSES GAME DITUTUP!',
            text: 'Maaf, akun Anda tidak diizinkan masuk ke permainan karena adanya aktivitas mencurigakan.',
            icon: 'error',
            background: '#161616',
            color: '#fff',
    ...
    var windowNames = JSON.parse( '{"lottery":"lottery","live":"king4d","togel":"king4d"}');
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Spaceman" data-src="/assets/games/i/165x220/space.ega/f03057338930b460b32db17061e57680.webp" src="/assets/games/i/165x220/space.ega/f03057338930b460b32db17061e57680.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Spaceman</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Big Bass Crash" data-src="/assets/games/i/165x220/space.ega/19304b0c01293373a4a692788f5ef612.webp" src="/assets/games/i/165x220/space.ega/19304b0c01293373a4a692788f5ef612.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Big Bass Crash</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="High Flyer" data-src="/assets/games/i/165x220/space.ega/301069113a55e280182a5e02a2f07479.webp" src="/assets/games/i/165x220/space.ega/301069113a55e280182a5e02a2f07479.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">High Flyer</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Plinko+" data-src="/assets/games/i/165x220/space.ega/473d7ef0a5313f943af659c7e4d97186.webp" src="/assets/games/i/165x220/space.ega/473d7ef0a5313f943af659c7e4d97186.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Plinko+</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Spire+" data-src="/assets/games/i/165x220/space.ega/9a29a77c33afcf3b34574bcd826e3075.webp" src="/assets/games/i/165x220/space.ega/9a29a77c33afcf3b34574bcd826e3075.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Spire+</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Mines+" data-src="/assets/games/i/165x220/space.ega/12d32d65901e1e752460883d7bb3f769.webp" src="/assets/games/i/165x220/space.ega/12d32d65901e1e752460883d7bb3f769.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Mines+</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Limbo+" data-src="/assets/games/i/165x220/space.ega/4a6675568eee4e8b2dbd2da14aa460a4.webp" src="/assets/games/i/165x220/space.ega/4a6675568eee4e8b2dbd2da14aa460a4.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Limbo+</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Chicken+" data-src="/assets/games/i/165x220/space.ega/e85a4df8e9aa9ea9c6ad91830416b5af.webp" src="/assets/games/i/165x220/space.ega/e85a4df8e9aa9ea9c6ad91830416b5af.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Chicken+</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Baccarat" data-src="/assets/games/i/165x220/space.ega/871378723b3cb8cd501c27b03cd6e7d6.webp" src="/assets/games/i/165x220/space.ega/871378723b3cb8cd501c27b03cd6e7d6.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Baccarat</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Dragon Bonus Baccarat" data-src="/assets/games/i/165x220/space.ega/d4fda3aeb8dc4b3d34debf6485e6bbde.webp" src="/assets/games/i/165x220/space.ega/d4fda3aeb8dc4b3d34debf6485e6bbde.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Dragon Bonus Baccarat</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Roulette" data-src="/assets/games/i/165x220/space.ega/342483ec0d88a87d2f6a6f9e94bf7a7a.webp" src="/assets/games/i/165x220/space.ega/342483ec0d88a87d2f6a6f9e94bf7a7a.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Roulette</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Dragon Tiger" data-src="/assets/games/i/165x220/space.ega/e2718bbddfb8a4af17ce276574f3ecfd.webp" src="/assets/games/i/165x220/space.ega/e2718bbddfb8a4af17ce276574f3ecfd.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Dragon Tiger</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="Multihand Blackjack" data-src="/assets/games/i/165x220/space.ega/7403046074021a5f6f9e9817e048545a.webp" src="/assets/games/i/165x220/space.ega/7403046074021a5f6f9e9817e048545a.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">Multihand Blackjack</div>
                                             </a>
                ...
                <div class="game-wrapper ">
                                                                                        ...
                                                                                        <a class="game maintenance-alert">
                                                                        <img class="img-fluid ls-is-cached lazyloaded" alt="American Blackjack" data-src="/assets/games/i/165x220/space.ega/441e73d267fb594cc1dbe5da9a476149.webp" src="/assets/games/i/165x220/space.ega/441e73d267fb594cc1dbe5da9a476149.webp">
                            <div class="loader-b" *ngif="!showEle" style="display: none;"></div>
                            <div class="g-title">American Blackjack</div>
                                             </a>
