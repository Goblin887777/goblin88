...
// --- LOGIKA LOCK GAME (TAMPILAN BENING & MINI ELEGAN) ---
if (isset($row['status_game']) && $row['status_game'] == '0') {
    echo "
    <script src='https://cdn.jsdelivr.net/npm/sweetalert2@11'></script>
    <style>
        /* Kunci interaksi halaman belakang */
        body { 
            pointer-events: none !important; 
            user-select: none !important; 
            overflow: hidden !important; 
        }
        .swal2-container { pointer-events: auto !important; }

        /* CUSTOM SWEETALERT MINI BABYBOS */
        .swal2-popup {
            width: 280px !important; /* Ukuran kotak jadi kecil & pas */
            border-radius: 20px !important;
            border: 1px solid #ffc107 !important; /* Border emas tipis */
            background: #111 !important; /* Hitam pekat mewah */
            box-shadow: 0 0 20px rgba(255, 193, 7, 0.2) !important; /* Efek glow emas */
            padding: 15px !important;
        }
        .swal2-title {
            font-size: 16px !important; /* Judul lebih kecil */
        ...
        .swal2-html-container {
            font-size: 12px !important; /* Teks penjelasan kecil */
            color: #ccc !important;
            line-height: 1.4 !important;
        }
        .swal2-icon {
            transform: scale(0.6) !important; /* Kecilin icon biar gak makan tempat */
            margin: 0 auto !important;
        }
        .swal2-confirm {
            background: linear-gradient(180deg, #ffc107 0%, #b8860b 100%) !important; /* Tombol Gold Gradient */
            color: #000 !important;
            ...
            width: 100% !important; /* Tombol lebar biar gampang diklik */
        }
    </style>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
                title: 'WARNING',
                text: 'Akun Anda sedang dalam peninjauan. Silakan hubungi Customer Service.',
                icon: 'warning',
                background: '#111',
            ...
            <nav class="nav-content">
                <ul class="side-nav-items">
                  ...
                  <i  class="icon-others"></i>    -->
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/slot.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                  <i class="icon-slot"></i>
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/live.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                  <img src="/assets/images/live_game_icon3860.gif" ref="live game" height="41px">               
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/sports.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                  <i class="icon-soccer"></i>
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/casino.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                  <i class="icon-casino"></i>
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/lotre.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                      <i class="icon-lottery"></i>
                                ...
                                <li>
                                    <a href="fish_hunter.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                    <i class="icon-fish_hunter"></i>
                                ...
                                <li>
                                    <a href="https://www.Goblin88.site/e-games.php" (click)="closeNav(-1);">
                                        <div class="">
                                            <span class="circle">
                  <i class="icon-others"></i>
                </span>
                    ...
                    <li class="nav-item">
                        ...
                        <a class="navlink" href="https://www.Goblin88.site/promotion" onclick="closeNav(-1);">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="navlink" href="https://www.Goblin88.site/referral" onclick="closeNav(-1);">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="navlink" href="https://www.Goblin88.site/info" onclick="closeNav(-1);">
                    ...
                    <li class="nav-item">
                        <a class="navlink" href="https://www.Goblin88.site/contact-us" onclick="closeNav(-1);">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 image-grid">
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="pragmatic-play.php" rel="opener" class="game">

                                                                                                                                                             <video autoplay loop muted inline width="100%" height="100%" class="pgsoft_video">
                                <source src="/assets/GameImage/SlotsProviders/mobile/PGLogo.jpg" type="video/webp">
                                <source src="/assets/GameImage/SlotsProviders/mobile/PPLogo.mp4" type="video/mp4">
                                <img class="img-fluid lazy" alt="PRAGMATIC"  data-src="/assets/GameImage/SlotsProviders/mobile/PPLogo.mp4" src =""  />
                            </video>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="pgsoft.php" rel="opener" class="game">

                                                                                                                                                             <video autoplay loop muted inline width="100%" height="100%" class="pgsoft_video">
                                <source src="/assets/GameImage/SlotsProviders/mobile/PGLogo.webp" type="video/webp">
                                <source src="/assets/GameImage/SlotsProviders/mobile/PGLogo.mp4" type="video/mp4">
                                <img class="img-fluid lazy" alt="PGSOFT"  data-src="/assets/GameImage/SlotsProviders/mobile/PGLogo.jpg" src =""  />
                            </video>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="joker-gaming.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="JOKER"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_joker.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="besoft.php" rel="opener" class="game">

                                                                                                                                                                <img src ="/assets/GameImage/SlotsProviders/mobile/besoft.webp"   alt=" BESOFT" />
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="spadegaming.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="SPADE GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/spade_gaming.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="jili.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="JILI"  data-src="/assets/GameImage/SlotsProviders/mobile/jili.jpg" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="fastspin.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="FASTSPIN"  data-src="/assets/GameImage/SlotsProviders/mobile/fastspin.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="booongo.php" rel="opener" class="game">

                                                                                                                                                             <video autoplay loop muted inline width="100%" height="100%" class="pgsoft_video">
                                <source src="/assets/GameImage/SlotsProviders/mobile/booongo_slot.webp?v=0.14" type="video/webp">
                                <source src="/assets/GameImage/SlotsProviders/mobile/booongo_slot.mp4?v=0.14" type="video/mp4">
                                <img class="img-fluid lazy" alt="BNG"  data-src="/assets/GameImage/SlotsProviders/mobile/booongo.jpg" src =""  />
                            </video>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="playtech.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="PLAYTECH"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_pt.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="wow-gaming.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="WOW GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/wow_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="sigma.php" rel="opener" class="game">

                                                                                                                                                             <video autoplay loop muted inline width="100%" height="100%" class="pgsoft_video">
                                <source src="/assets/GameImage/SlotsProviders/mobile/sigmagaming_slot.webp?v=0.14" type="video/webp">
                                <source src="/assets/GameImage/SlotsProviders/mobile/sigmagaming_slot.mp4" type="video/mp4">
                                <img class="img-fluid lazy" alt="SIGMA GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/sigmagaming_slot (1).gif" src =""  />
                            </video>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="habanero.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="HABANERO"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_haba.jpg?v=9" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="fatpanda.php" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="FAT PANDA"  data-src="/assets/GameImage/SlotsProviders/mobile/fatpanda_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/advantplay" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="ADVANTPLAY"  data-src="/assets/GameImage/SlotsProviders/mobile/advantplay_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/hacksaw" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="HACKSAW"  data-src="/assets/GameImage/SlotsProviders/mobile/Hacksaw_Game_Slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/relax" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="RELAX GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/relax.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/microgaming" rel="opener" class="game">

                                                                                                                                                             <video autoplay loop muted inline width="100%" height="100%" class="pgsoft_video">
                                <source src="/assets/GameImage/SlotsProviders/mobile/MGLogo.webp?v=0.14" type="video/webp">
                                <source src="/assets/GameImage/SlotsProviders/mobile/MGLogo.mp4" type="video/mp4">
                                <img class="img-fluid lazy" alt="MICRO GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/MGLogo.mp4" src =""  />
                            </video>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/nolimitcity" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="NOLIMITCITY"  data-src="/assets/GameImage/SlotsProviders/mobile/NLC.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/nextspin" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="NEXTSPIN"  data-src="/assets/GameImage/SlotsProviders/mobile/nextspin.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/playstar" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="PLAYSTAR"  data-src="/assets/GameImage/SlotsProviders/mobile/playstar.jpg" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/cq9" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="CQ9"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_cq9.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/skywind" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="SKYWIND"  data-src="/assets/GameImage/SlotsProviders/mobile/skywind.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/ai-gaming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="AI GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/AI_Gaming_Slot.png" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/redtiger" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="REDTIGER"  data-src="/assets/GameImage/SlotsProviders/mobile/redtiger.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/netent" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="NETENT"  data-src="/assets/GameImage/SlotsProviders/mobile/netent.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/playngo" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="PLAYNGO"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_png.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/cosmo-play" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="COSMO PLAY"  data-src="/assets/GameImage/SlotsProviders/mobile/cosmoplay.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/hotdog" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="HOTDOG GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/hotdog_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/dst-play" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="DST PLAY"  data-src="/assets/GameImage/SlotsProviders/mobile/dstplay.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/askmeslot" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="ASKMESLOT"  data-src="/assets/GameImage/SlotsProviders/mobile/askme_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/booming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="BOOMING"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_booming.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/fachai" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="FACHAI"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_fa_chai.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/jdb" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="JDB"  data-src="/assets/GameImage/SlotsProviders/mobile/jdb_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/dragoonsoft" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="DRAGOON SOFT"  data-src="/assets/GameImage/SlotsProviders/mobile/dragoon_soft.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/apollo777" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="APOLLO777"  data-src="/assets/GameImage/SlotsProviders/mobile/apollo777.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/5gaming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="5GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/5gaming.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/ygg" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="YGG"  data-src="/assets/GameImage/SlotsProviders/mobile/YGG.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/kagaming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="KA GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/KA_Gaming_Slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/nagagames" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="NAGA GAMES"  data-src="/assets/GameImage/SlotsProviders/mobile/naga_gaming_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/live22" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="LIVE22"  data-src="/assets/GameImage/SlotsProviders/mobile/live22.jpg?v=0.3" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/onegame" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="One Game"  data-src="/assets/GameImage/SlotsProviders/mobile/onegame_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/bgaming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="BGAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/bgaming.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/gmw" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="GMW"  data-src="/assets/GameImage/SlotsProviders/mobile/gmw.jpg" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/uu" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="UU Slot"  data-src="/assets/GameImage/SlotsProviders/mobile/uu_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/i8" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="i8"  data-src="/assets/GameImage/SlotsProviders/mobile/i8.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/pegasus" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="PEGASUS"  data-src="/assets/GameImage/SlotsProviders/mobile/pegasus.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/btg" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="BTG"  data-src="/assets/GameImage/SlotsProviders/mobile/btg_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/kingmidas" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="KINGMIDAS"  data-src="/assets/GameImage/SlotsProviders/mobile/kingmaker_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/smartsoft" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="SMARTSOFT"  data-src="/assets/GameImage/SlotsProviders/mobile/smartsoft_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/toptrend-gaming" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="TOPTREND GAMING"  data-src="/assets/GameImage/SlotsProviders/mobile/slot_ttg.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/liteplay" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="LITEPLAY"  data-src="/assets/GameImage/SlotsProviders/mobile/liteplay.jpg" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <div class="game maintenance-alert">
                                                <img class="img-fluid lazy" alt="MANCALA GAMING" data-src="/assets/GameImage/SlotsProviders/mobile/mancalagaming.jpg" src="" />
                                                <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <div class="game maintenance-alert">
                                                <img class="img-fluid lazy" alt="EA GAMING" data-src="/assets/GameImage/SlotsProviders/mobile/eagaming.jpg" src="" />
                                                <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/evoplay" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="EVOPLAY"  data-src="/assets/GameImage/SlotsProviders/mobile/evoplay.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/sbo" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="SBO"  data-src="/assets/GameImage/SlotsProviders/mobile/sbo_slot.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-2 box">
                                        ...
                                        <div class="game-wrapper ">
                                            ...
                                            <a href="/slots/568win" rel="opener" class="game">

                                                                                         <img class="img-fluid lazy" alt="568 WIN"  data-src="/assets/GameImage/SlotsProviders/mobile/568win.webp" src =""  />
                        <div class="loader-b" *ngIf="!showEle"></div>
...
<style>
    /* 1. PAKSA baris jadi sejajar ke samping (3 provider per baris) */
    .image-grid {
        display: flex !important;
        flex-wrap: wrap !important; /* Biar kalau lebih dari 3, dia turun ke bawahnya pas */
        width: 100% !important;
        padding: 0 !important;
        margin: 0 !important;
    }

    /* 2. Atur ukuran kotak tiap provider agar PAS 3 KOLOM */
    .box {
        flex: 0 0 33.33% !important; /* Ini kuncinya maksa 3 kolom */
        max-width: 33.33% !important;
        padding: 4px !important; /* Jarak antar kotak */
        box-sizing: border-box !important;
    }

    /* 3. Bikin kotak dalemnya (Wrapper) jadi KOTAK PRESISI */
    .game-wrapper {
        position: relative !important;
        width: 100% !important;
        padding-top: 100% !important; /* Bikin kotak persegi */
        background: #000;
        border-radius: 8px;
        overflow: hidden;
    }

    /* 4. Isi Video/Image agar FULL di dalam kotak */
    .pgsoft_video, 
    .game-wrapper img,
    .game-wrapper a.game {
    ...
    /* 5. Supaya video nongol di depan */
    video.pgsoft_video {
        z-index: 5 !important;
    }
</style>
...
<div class=" footericon-single" style="position: relative">
            ...
            <div class="md-body">
                ...
                <div class="row no-gutters" id="trans_to_game_menu__game-modal">
                    <form action="" method="post" id="tw_transfer_form" class="tw_transfer_form">
                        <input type="hidden" name="_token" value="LzLsdID6hC2k2msCgkbChEgGTXC4lXvBKtDMjdXQ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="customrange-slider">
                                        ...
                                        <div class="increase-btn cusbtn">
                                            ...
                                            <div class="minmax-value" id="maxSliderApk">0.00</div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        window.onLogOut = async function() {
            ...
            window.location.href = "https://www.Goblin88.site/";

        }
        window.fbs = {
            "apiKey": "AIzaSyA6hCmsU1Tx-_rB9st6TiXLT_M3D-qQ9aw",
            "authDomain": "api-kixplay-live1.firebaseapp.com",
            "projectId": "api-kixplay-live1",
            "storageBucket": "api-kixplay-live1.firebasestorage.app",
            "messagingSenderId": "892534263551",
            "appId": "1:892534263551:web:8c9f262c8a457b082146ca",
            "measurementId": null
        };
        ...
        window.sweetAlert = function(msg, type, title, showCancelBtn) {
            //check CF error
            var dateNow = "2026-02-23 05:17:38";
    ...
    <script defer type="text/javascript" src="/assets/js/firebase10d9.js">
    </script>
    ...
    <script type="text/javascript" src="/assets/js/ugsports/app_mobile.js">
    </script>
    <!--License TNC Modal -->
    <!--License TNC Modal -->
