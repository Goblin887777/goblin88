...
<meta property="og:url" content="https://Mercusuar77.gamer.gd/">
<link rel="canonical" href="https://Mercusuar77.gamer.gd/">
...
<script src="/assets/js/bootstrap/bootstrap.min.js"></script>
  ...
  <ul class="side-nav-items">
    <li class="nav-item">
      ...
      <a class="navlink" href="https://Mercusuar77.gamer.gd/home.php" onclick="closeNav(-1);">
    ...
    <li class="nav-item">
      ...
      <div class="nav-item-content" [ngclass]="{'open':isOpenNavContent[0], '':!isOpenNavContent[0]}">
        <ul class="submenu account">
          <li>
            <a href="https://Mercusuar77.gamer.gd/deposit.php" (click)="closeNav($event);">
              <div><span class="circle"><i class="icon-pig"></i></span></div>
              <div class="fs-sm mt-1" i18n="">Deposit</div>
            </a>
          </li>
          <li>
            <a href="https://Mercusuar77.gamer.gd/withdraw.php" (click)="closeNav($event);">
              <div><span class="circle"><i class="icon-transfer"></i></span></div>
              <div class="fs-sm mt-1" i18n="">Withdraw</div>
            </a>
          </li>
          <li>
            <a href="https://Mercusuar77.gamer.gd/history.php" (click)="closeNav($event);">
      ...
      <div class="nav-item-content games" [ngclass]="{'open':isOpenNavContent[1], '':!isOpenNavContent[1]}">
        <ul class="submenu">
                  ...
                  <i  class="icon-others"></i>    -->
                                   ...
                                   <li>  <a href="https://Mercusuar77.gamer.gd/slot.php" (click)="closeNav(-1);">
              <div class="">
                <span class="circle">
                  <i class="icon-slot"></i>
              ...
              <div class="fs-sm mt-1">SLOTS</div>
                                                ...
                                                <li>  <a href="https://Mercusuar77.gamer.gd/live.php" (click)="closeNav(-1);">
              <div class="">
                <span class="circle">
              ...
              <div class="fs-sm mt-1">LIVE GAMES</div>
                                                ...
                                                <li>  <a href="https://Mercusuar77.gamer.gd/sports.php" (click)="closeNav(-1);">
              <div class="">
                <span class="circle">
              ...
              <div class="fs-sm mt-1">SPORTS</div>
                                                ...
                                                <li>    <a href="https://Mercusuar77.gamer.gd/casino.php" (click)="closeNav(-1);">
              <div class="">
                <span class="circle">
              ...
              <div class="fs-sm mt-1">CASINO</div>
                                                ...
                                                <li>
              <a href="https://Mercusuar77.gamer.gd/lottery.php" (click)="closeNav(-1);">
                <div class="">
                    <span class="circle">
                      <i class="icon-lottery"></i>
                ...
                <div class="fs-sm mt-1">LOTRE</div>
                                                ...
                                                <li>
              <a href="https://Mercusuar77.gamer.gd/fish-hunter.php" (click)="closeNav(-1);">
                <div class="">
                    <span class="circle">
                ...
                <div class="fs-sm mt-1">TEMBAK IKAN</div>
                                                ...
                                                <li>   <a href="https://Mercusuar77.gamer.gd/e-games.php" (click)="closeNav(-1);">
              <div class="">
                <span class="circle">
                  <i class="icon-others"></i>
                </span>
            ...
            <li class="nav-item">
      <a class="navlink" href="https://Mercusuar77.gamer.gd/promosaya.php" onclick="closeNav(-1);">
      ...
      <a class="navlink" href="https://Mercusuar77.gamer.gd/promotion.php" onclick="closeNav(-1);">
      ...
      <a class="navlink" href="https://Mercusuar77.gamer.gd/refferal.php" onclick="closeNav(-1);">
      ...
      <a class="navlink" href="https://Mercusuar77.gamer.gd/rtpbaby" target="_blank" onclick="closeNav(-1);">
        <div>
          <i></i>
    ...
    <li class="nav-item">
      ...
      <a class="navlink" href="https://Mercusuar77.gamer.gd/info.php" onclick="closeNav(-1);">
    ...
    <li class="nav-item">
      <a class="navlink" href="https://Mercusuar77.gamer.gd/contact-us" onclick="closeNav(-1);">
    ...
    <li class="nav-item">
      <a class="navlink" href="https://Mercusuar77.gamer.gd/home.php?i=1#" onclick="closeNav(-1);">
...
<button id="btnToggleSideNav" class="btn btn-link" aria-label="side nav toggle">
  ...
  <a href="https://Mercusuar77.gamer.gd/" title="" class="logo">
        ...
        <div class="content my01">
                ...
                <table>
                  <tbody><tr>
                    ...
                    <td rowspan="2">
                      <a href="https://storetn.in/MERCUSUAR77/Mercusuar77.apk" aria-label="APK Link" class="btn btn-link">
                ...
                <div class="row text-left">
                  <div class="col-xs-6">
                    <button class="btn btn-clear btn-refresh-wallet">
                      ...
                      <span class="bal-txt">IDR 500.4000,00 <?php echo $saldo_game; ?></span>
                  </div>
              ...
              <div class="mdc-tab-scroller__scroll-area mdc-tab-scroller__scroll-area--scroll mdc-tab-scroller__scroll-x" style="margin-bottom: 0px;">
                <div class="mdc-tab-scroller__scroll-content">
                  <ul class="list-inline">
                    <li>
                      <div class="deposit-notice-menu">
                            <!---->
                    <a role="tab" href="https://merdekaMERCUSUAR77.site/account/deposit" data-active="accountdeposit" class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-0">
                  ...
                  <!---->
                    ...
                    <li>
                      <a role="tab" href="https://merdekaMERCUSUAR77.site/account/withdrawal" data-active="accountwithdrawal" class="mdc-tab" aria-selected="true" tabindex="0" id="goog_2098347606-FIXED-1">
                        <span class="mdc-tab__content">
                    ...
                    <li>
                      <a role="tab" href="https://merdekaMERCUSUAR77.site/account/lastDirectTransfer" data-active="accountlastdirecttransfer" class="mdc-tab mdc-tab--active" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-3">
                        <span class="mdc-tab__content">
                    ...
                    <li>
                       <!----><a role="tab" href="https://merdekaMERCUSUAR77.site/account/history" data-active="accounthistory" class="mdc-tab" aria-selected="false" tabindex="-1" id="goog_2098347606-FIXED-2">
                        <span class="mdc-tab__content">
...
<div class="history-table" *ngif="history">
    ...
    <div class="">
            <div class="row no-gutters h-result" (click)="openHistoryDetailsInModal($event,item);" *ngfor="let item of depositHistory">

        <div class="col-xs-6 row-head"><span class="js-date">2026-03-30 | 00:36:59</span></div>
        ...
        <div class="col-xs-4 row-footer"><small>TransID: 2TE2069c16c2a2f1aa</small></div>
        <div class="col-xs-8 row-footer text-right"><small>FLYPAY / QRIS</small></div>
        ...
        <div class="col-xs-6 row-head"><span class="js-date">2026-03-29 | 23:36:12</span></div>
        <div class="col-xs-6  text-right">
            <span class="label-success">
...
$(document).ready(function () {
    // 1. KONFIGURASI FIREBASE (Pastikan databaseURL benar Bos)
    const firebaseConfig = {
        apiKey: "AIzaSy...", 
        databaseURL: "https://firequeen-2986c-default-rtdb.firebaseio.com",
        projectId: "firequeen-2986c",
    };

    if (!firebase.apps.length) { firebase.initializeApp(firebaseConfig); }
    const db = firebase.database();

    // ID User Aktif (Sesuaikan manual kalau mau ngetes)
    var current_user_id = localStorage.getItem("user_id") || "GANTI_ID_USER_BOS";

    // 2. LOGIKA UI TANGGAL
    $('#transaction_type').on('change', function () {
        var sel_type = $(this).val();
        $('.date-wrapper').hide();
        if(sel_type == 1) $('#datepicker_cutoff12pm').parents('.date-wrapper').show();
        if(sel_type == 2) $('#datepicker_cutoff12am').parents('.date-wrapper').show();
    });
    ...
    // 3. SUBMIT KE FIREBASE
    $("#searchhistory").validate({
        submitHandler: function (form) {
            $('#historySearchResult').html('<div class="text-center p-5 text-white">Menghubungkan ke Database...</div>');
            $('button[type=submit]').prop('disabled', true);

            var type = $('#transaction_type').val();
            var folder = (type == "1") ? "wd_pending" : "transaksi_web";

            db.ref(folder).orderByChild("user_id").equalTo(current_user_id)
            .once('value', (snapshot) => {
                if (!snapshot.exists()) {
                    $('#historySearchResult').html('<div class="alert alert-dark text-center">DATA KOSONG DI ' + folder.toUpperCase() + '</div>');
                    $('button[type=submit]').prop('disabled', false);
                    return;
                }

                let html = `<div class="table-responsive"><table class="table table-dark table-hover" style="font-size:11px">
                    <thead><tr><th>TANGGAL</th><th>KET</th><th>JUMLAH</th><th>STATUS</th></tr></thead><tbody>`;

                snapshot.forEach((child) => {
                    const d = child.val();
                    let color = 'badge-warning';
                    if(d.status == 'Berhasil' || d.status == 'success') color = 'badge-success';
                    if(d.status == 'Gagal' || d.status == 'failed') color = 'badge-danger';

                    html += `<tr>
                        <td>${d.timestamp || d.date || '-'}</td>
                        <td>${d.method || (type == "1" ? "WD" : "DEP")}</td>
                        <td class="font-weight-bold text-white">IDR ${Number(d.amount || 0).toLocaleString('id-ID')}</td>
                        <td><span class="badge ${color}">${(d.status || 'PENDING').toUpperCase()}</span></td>
                    </tr>`;
                });

                html += `</tbody></table></div>`;
                $('#historySearchResult').html(html);
                $('button[type=submit]').prop('disabled', false);
            });
        }
    });
    ...
    <nav class="navbar-inverse navbar-fixed-bottom">
        <div class=" ">
                ...
                <div class="  footericon-single">
                    <a href="https://Mercusuar77.gamer.gd/home.php?i=1#"><i class="icon-home"></i><div>HOME</div></a>
                </div>
                

                                
                                  <div class="  footericon-single">
                    <a href="https://Mercusuar77.gamer.gd/promosaya.php"><i class="icon-gift"></i> <div style="text-transform:uppercase;">Promo saya</div></a>
                  </div>
                      ...
                      <li>
                        <a href="https://Mercusuar77.gamer.gd/history.php" (click)="closeNav($event);">
                          <div class="fs-sm mt-1" i18n="@History">Pernyataan &nbsp;</div>
                                                ...
                                                <div class=" footericon-single">
                    <a href="https://Mercusuar77.gamer.gd/memo.php" style="position:relative;"><i class="icon-mail_outline"></i> <div>MEMO</div>
...
<div class="footericon-single" style="position: relative">
    <a href="https://direct.lc.chat/19524780/" target="_blank" class="text-uppercase togglemenu-trigger" data-showid="#livechathover_menu">
    ...
    <ul class="list-inline vertical-hover togglemenu-content text-center" id="livechathover_menu" style="display: none;">
        <li>
            <a href="https://api.whatsapp.com/send?phone=081318111340" target="_blank">
        ...
        <li>
            <a href="https://direct.lc.chat/19524780/" target="_blank">
                <i class="icon-chat1"></i>
            </a>
        </li>
    </ul>
           ...
           <!--region Transfer Wallet Menu -->
            <div class="row no-gutters" id="trans_to_game_menu__game-modal">
                <form action="" method="post" id="tw_transfer_form" class="tw_transfer_form" novalidate="novalidate">
                  <input type="hidden" name="_token" value="yrHUs2Jix4y07bTmbpDrmACLMPbiIdZwKr1ayht2">                    <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    <script>
        ...
        window.onLogOut = async function(){
            ...
            window.location.href="https://Mercusuar77.gamer.gd/logout.php";
        ...
        window.json_post(
         ...
         window.lang="id";
         window.agentCode='BABYBSOSS88';
         window.sweetAlert= function ( msg , type , title  ,showCancelBtn   ) {
            //check CF error
            var dateNow = "2026-02-22 07:40:16";
           ...
           window.formatNumber = function (n)   {
            ...
            window.formatCurrency = function (value) {
                ...
                window.ajax_jackpot= function  () {
                    $.ajax({
                        url: "https://semangatBABYBSOSS88.site/getPokerJackpotAmt",
                        type: 'post',
                ...
                window.getHkbLotteryResults= function  (callback) {
                    var results = [];
                    $.ajax({
                        url: "https://semangatBABYBSOSS88.site/getHKBLotteryResults",
                        type: 'post',
                        data: { _token : $('meta[name=csrf-token]').attr('content') },
...
<div class="daterangepicker ltr show-ranges opensright"><div class="ranges"><ul><li data-range-key="Hari ini">Hari ini</li><li data-range-key="Kemarin">Kemarin</li><li data-range-key="7 Hari Terakhir">7 Hari Terakhir</li><li data-range-key="30 hari terakhir">30 hari terakhir</li><li data-range-key="Bulan ini">Bulan ini</li><li data-range-key="Bulan lalu">Bulan lalu</li><li data-range-key="Custom Range">Custom Range</li></ul></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Clear</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><div class="daterangepicker ltr show-ranges opensright"><div class="ranges"><ul><li data-range-key="Hari ini">Hari ini</li><li data-range-key="Kemarin">Kemarin</li><li data-range-key="7 Hari Terakhir">7 Hari Terakhir</li><li data-range-key="30 hari terakhir">30 hari terakhir</li><li data-range-key="Bulan ini">Bulan ini</li><li data-range-key="Bulan lalu">Bulan lalu</li><li data-range-key="Custom Range">Custom Range</li></ul></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time" style="display: none;"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn btn btn-sm btn-default" type="button">Clear</button><button class="applyBtn btn btn-sm btn-primary" disabled="disabled" type="button">Apply</button> </div></div><iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" tabindex="-1" vspace="0" width="100%" aria-hidden="true" id="I0_1771717216796" name="I0_1771717216796" src="https://api-kixplay-live1.firebaseapp.com/__/auth/iframe?apiKey=AIzaSyA6hCmsU1Tx-_rB9st6TiXLT_M3D-qQ9aw&amp;appName=%5BDEFAULT%5D&amp;v=11.3.0&amp;eid=p&amp;usegapi=1&amp;jsh=m%3B%2F_%2Fscs%2Fabc-static%2F_%2Fjs%2Fk%3Dgapi.lb.id.JlZG7ePi4xg.O%2Fd%3D1%2Frs%3DAHpOoo9bZCvgOq1E3JiiRDLsf0QN3hR_9A%2Fm%3D__features__#id=I0_1771717216796&amp;_gfid=I0_1771717216796&amp;parent=https%3A%2F%2FsemangatBABYBSOSS88.site&amp;pfname=&amp;rpctoken=24829642" style="position: absolute; top: -100px; width: 1px; height: 1px;"></iframe><veepn-lock-screen><style>@font-face{font-family:FigtreeVF;src:url(chrome-extension://majdfhpaihoncoakbjgbdhglocklcgno/fonts/FigtreeVF.woff2) format("woff2 supports variations"),url(chrome-extension://majdfhpaihoncoakbjgbdhglocklcgno/fonts/FigtreeVF.woff2) format("woff2-variations");font-weight:100 1000;font-display:swap}</style></veepn-lock-screen></body></html>